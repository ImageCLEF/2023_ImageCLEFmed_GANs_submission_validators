...
class TestValidation(unittest.TestCase):
    def setUp(self):
        self.imageCLEFGansTask1Validator = ImageCLEFGansTask1Validator(
            image_ids_file_path)
    ...
    def test_wrong_format_1(self):
        self.assertRaisesRegex(SubmissionValidationException, "^Wrong format",
                               self.imageCLEFGansTask1Validator.validate_format, "01_1_empty_line.csv")

    def test_wrong_format_2(self):
        self.assertRaisesRegex(SubmissionValidationException, "^Wrong format",
                               self.imageCLEFGansTask1Validator.validate_format, "01_2_wrong_format.csv")
    ...
    def test_wrong_score_1(self):
        self.assertRaisesRegex(SubmissionValidationException, "^Wrong score 'aaaaaaa'.",
                               self.imageCLEFGansTask1Validator.validate_format, "04_1_score_no_int.csv")

    def test_wrong_score_2(self):
        self.assertRaisesRegex(SubmissionValidationException, "^Wrong score '2'.",
                               self.imageCLEFGansTask1Validator.validate_format, "04_2_score_int_greater_than_1.csv")

    def test_wrong_score_3(self):
        self.assertRaisesRegex(SubmissionValidationException, "^Wrong score '-1'.",
                               self.imageCLEFGansTask1Validator.validate_format, "04_3_score_int_smaller_than_0.csv")
